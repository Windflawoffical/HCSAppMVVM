...
public class MockBase implements AddAppeal, AppealsList {
    ...
    public MockBase() {
        ...
        list.add(new Appeal("Жалоба №1", "Описание жалобы №1", "Image1"));
        list.add(new Appeal("Жалоба №2", "Описание жалобы №2", "Image2"));
        list.add(new Appeal("Жалоба №3", "Описание жалобы №3", "Image3"));
        list.add(new Appeal("Жалоба №4", "Описание жалобы №4", "Image4"));
        list.add(new Appeal("Жалоба №5", "Описание жалобы №5", "Image5"));
